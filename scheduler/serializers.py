...
class CompanyConfigSerializer(serializers.Serializer):
    ...
    availability_free_label = serializers.CharField()
    availability_regular_label = serializers.CharField()
    availability_no_free_label = serializers.CharField()
    extras_label = serializers.CharField()
